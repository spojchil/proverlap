...
class TierClassifierTest {
    ...
    void pureDocs30Lines() {
        TierLevel result = classifier.classify(30, List.of("README.md", "docs/guide.md"));
    ...
    void pureConfig10Lines() {
        TierLevel result = classifier.classify(10, List.of("application.yml", "config.properties"));
        assertEquals(TierLevel.TIER_1, result);
    }
    ...
    void javaFile30Lines() {
        TierLevel result = classifier.classify(30, List.of("src/main/Foo.java"));
    ...
    void standard200Lines() {
        TierLevel result =
                classifier.classify(200, List.of("src/main/Foo.java", "README.md", "pom.xml"));
        assertEquals(TierLevel.TIER_2, result);
    }
    ...
    void mixedFiles51Lines() {
        TierLevel result = classifier.classify(51, List.of("Foo.java", "README.md"));
        assertEquals(TierLevel.TIER_2, result);
    }
    ...
    void superLargeDiff() {
        TierLevel result = classifier.classify(600, List.of("src/main/Foo.java"));
    ...
    void sensitiveAuthFile() {
        TierLevel result = classifier.classify(10, List.of("src/auth/LoginService.java"));
        assertEquals(TierLevel.TIER_3, result);
    }
    ...
    void sensitiveSqlFile() {
        TierLevel result = classifier.classify(5, List.of("migration/V1__init.sql"));
        assertEquals(TierLevel.TIER_3, result);
    }
    ...
    void sensitiveSecurityName() {
        TierLevel result = classifier.classify(5, List.of("src/util/SecurityUtils.java"));
        assertEquals(TierLevel.TIER_3, result);
    }
