 ...
 * 判定优先级：
 * <ol>
 *   <li>diff 行数超 t2MaxDiffLines(500) → Tier 3</li>
 *   <li>变更文件包含敏感路径（auth/security/sql/migration）→ Tier 3</li>
 *   <li>diff ≤ 50 行且全为非代码文件 → Tier 1</li>
 *   <li>其余情况 → Tier 2</li>
 * </ol>
 */
@Slf4j
...
public class TierClassifier {
    ...
    private static final Set<String> NON_CODE_EXTENSIONS = Set.of(
            ".md", ".yml", ".yaml", ".properties", ".xml",
            ".json", ".txt", ".gitignore", ".editorconfig", ".csv");
