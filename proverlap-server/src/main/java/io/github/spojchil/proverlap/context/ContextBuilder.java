 ...
 * 审查上下文组装器。
 *
 * <p>将 diff、变更文件的完整内容、项目规范文件拼装为 LLM 审查可用的完整上下文。 上下文限制由 {@link ContextProperties} 注入，可在
 * application.yml 按需调整。
 */
@Slf4j
@Service
...
public class ContextBuilder {
    ...
    /** 规范文件列表 */
    private static final List<String> SPEC_FILES =
            List.of("CLAUDE.md", "CONTRIBUTING.md", ".editorconfig");

    /** 代码文件扩展名 */
    private static final Set<String> CODE_EXTENSIONS =
            Set.of(
                    ".java", ".py", ".js", ".ts", ".jsx", ".tsx", ".go", ".rs", ".c", ".cpp", ".h",
                    ".hpp", ".cs", ".rb", ".php", ".swift", ".kt", ".scala", ".sql");
    ...
    public String build(String owner, String repo, String diff, String ref) {
        ...
        String trimmed =
                diff.length() > props.getMaxDiffSize()
    ...
    /** 追加变更文件的完整内容 */
    private void appendFullFiles(
            String owner, String repo, List<String> files, StringBuilder ctx, String ref) {
    ...
    static String trimLines(String content, int maxLines) {
        ...
        sb.append("... (文件过长，已截断，完整内容 ").append(totalLines).append(" 行)\n");
        return sb.toString();
    }
}
